...
const brandCreate = (name, cars, callback) => {
  branddetail = {
    name: name,
  };
  if (cars != false) branddetail.cars = cars;
...
const categoryCreate = (name, description, cars) => {
  categorydetail = {
    name: name,
    description: description,
  };
  if (cars != false) categorydetail.cars = cars;
